# Concepts: Relational to Graph - Neo4j Graph Database Platform
...
> You should be familiar with the relational database model and understand the basics of the [property-graph model](chrome-extension://cjedbglnccaioiolemnfhjncicchinao/developer/graph-database#property-graph). It is also helpful to understand basic data modeling questions and concepts.
...
[](#relational-to-graph)Translating Relational Knowledge to Graphs
------------------------------------------------------------------
...
[](#rdbms-graph-model)Data Model Differences
--------------------------------------------
...
[](#rdbms-graph-query)Data Storage and Retrieval
------------------------------------------------
...
[](#rdbms-graph-practice)Transitioning from Relational to Graph - In Practice
-----------------------------------------------------------------------------
...
<table><tbody><tr><td><i title="Tip"></i></td><td><p>For more information, you can visit our pages for <a href="https://neo4j.com/developer/language-guides/" target="_blank" rel="noopener">Building Applicatons</a> to see how to connect to Neo4j using different programming languages.</p></td></tr></tbody></table>
