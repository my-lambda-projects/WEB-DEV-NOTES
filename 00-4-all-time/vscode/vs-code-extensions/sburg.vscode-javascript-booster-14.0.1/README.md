...
PRs are always welcome. Please refer to the [Contribution Guide](https://github.com/xsburg/vscode-javascript-booster/blob/master/CONTRIBUTING.md) for tips on how to work with this project. The guide includes basic development workflows like running tests and debugging as well as useful links for creating new code actions.
