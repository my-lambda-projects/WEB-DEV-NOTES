...
export class PDFEditorProvider implements vscode.CustomReadonlyEditorProvider {
	...
	private static readonly viewType = 'analyticsignal.preview-pdf';
	...
	//
	private getWebviewContent(webview: vscode.Webview, uri: vscode.Uri, fill: boolean): string {
		...
		function stylesheet(href: vscode.Uri) {
