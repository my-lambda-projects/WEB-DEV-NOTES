  ...
  (function (l) {
    ...
    (function () {
      ...
      var j = (b.each = b.forEach = function (a, c, d) {
        if (a != null)
          if (A && a.forEach === A) a.forEach(c, d);
          else if (a.length === +a.length)
            for (var e = 0, f = a.length; e < f; e++) {
              if (c.call(d, a[e], e, a) === p) break;
            }
          else
            for (var g = b.keys(a), e = 0, f = g.length; e < f; e++)
              if (c.call(d, a[g[e]], g[e], a) === p) break;
      });
      b.map = b.collect = function (a, c, b) {
        var e = [];
        if (a == null) return e;
        if (B && a.map === B) return a.map(c, b);
        j(a, function (a, g, h) {
          e.push(c.call(b, a, g, h));
        });
        return e;
      };
      ...
      b.every = b.all = function (a, c, d) {
        ...
        var e = true;
        if (a == null) return e;
        if (F && a.every === F) return a.every(c, d);
        j(a, function (a, b, h) {
          if (!(e = e && c.call(d, a, b, h))) return p;
        });
        return !!e;
      };
      var I = (b.some = b.any = function (a, c, d) {
        c || (c = b.identity);
        var e = false;
        if (a == null) return e;
        if (G && a.some === G) return a.some(c, d);
        j(a, function (a, b, h) {
          if (e || (e = c.call(d, a, b, h))) return p;
        });
        return !!e;
      ...
      b.where = function (a, c, d) {
        return b.isEmpty(c)
          ? d
            ? void 0
            : []
          : b[d ? "find" : "filter"](a, function (a) {
              for (var b in c) if (c[b] !== a[b]) return false;
              return true;
            });
      };
      b.findWhere = function (a, c) {
        return b.where(a, c, true);
      };
      b.max = function (a, c, d) {
        if (!c && b.isArray(a) && a[0] === +a[0] && a.length < 65535)
      ...
      b.sample = function (a, c, d) {
        return arguments.length < 2 || d
          ? a[b.random(a.length - 1)]
          : b.shuffle(a).slice(0, Math.max(0, c));
      };
      var v = function (a) {
      ...
      b.sortBy = function (a, c, d) {
        ...
        return b.pluck(
          b
            .map(a, function (a, c, b) {
              return { value: a, index: c, criteria: e.call(d, a, c, b) };
            })
            .sort(function (a, c) {
              var b = a.criteria,
                d = c.criteria;
      ...
      var w = function (a) {
        return function (c, d, e) {
          var f = {},
            g = d == null ? b.identity : v(d);
          j(c, function (b, d) {
            var i = g.call(e, b, d, c);
            a(f, i, b);
          });
          return f;
        };
      };
      b.groupBy = w(function (a, c, d) {
        (b.has(a, c) ? a[c] : (a[c] = [])).push(d);
      });
      b.indexBy = w(function (a, c, b) {
        a[c] = b;
      });
      b.countBy = w(function (a, c) {
        b.has(a, c) ? a[c]++ : (a[c] = 1);
      });
      b.sortedIndex = function (a, c, d, e) {
        for (
          var d = d == null ? b.identity : v(d),
            c = d.call(e, c),
            f = 0,
            g = a.length;
          f < g;
      ...
      b.first = b.head = b.take = function (a, c, b) {
        return a == null ? void 0 : c == null || b ? a[0] : i.call(a, 0, c);
      };
      b.initial = function (a, c, b) {
        return i.call(a, 0, a.length - (c == null || b ? 1 : c));
      };
      b.last = function (a, c, b) {
        return a == null
          ...
          : c == null || b
          ? a[a.length - 1]
          : i.call(a, Math.max(a.length - c, 0));
      };
      ...
      var J = function (a, c, d) {
        if (c && b.every(a, b.isArray)) return r.apply(d, a);
        j(a, function (a) {
      ...
      b.uniq = b.unique = function (a, c, d, e) {
        ...
        var d = d ? b.map(a, d, e) : a,
          ...
          g = [];
        j(d, function (d, e) {
          if (c ? !e || g[g.length - 1] !== d : !b.contains(g, d)) {
            g.push(d);
            f.push(a[e]);
          }
        });
      ...
      b.difference = function (a) {
        var c = r.apply(k, i.call(arguments, 1));
      ...
      b.zip = function () {
        for (
          var a = b.max(b.pluck(arguments, "length").concat(0)),
            c = Array(a),
            d = 0;
          d < a;
          d++
        )
          c[d] = b.pluck(arguments, "" + d);
        return c;
      };
      b.object = function (a, b) {
        if (a == null) return {};
        for (var d = {}, e = 0, f = a.length; e < f; e++)
          b ? (d[a[e]] = b[e]) : (d[a[e][0]] = a[e][1]);
        return d;
      };
      b.indexOf = function (a, c, d) {
        ...
        if (s && a.indexOf === s) return a.indexOf(c, d);
        for (; e < f; e++) if (a[e] === c) return e;
        return -1;
      };
      b.lastIndexOf = function (a, b, d) {
        if (a == null) return -1;
        var e = d != null;
        if (H && a.lastIndexOf === H)
          return e ? a.lastIndexOf(b, d) : a.lastIndexOf(b);
        for (d = e ? d : a.length; d--; ) if (a[d] === b) return d;
        return -1;
      };
      ...
      b.bind = function (a, c) {
        var d, e;
        if (u && a.bind === u) return u.apply(a, i.call(arguments, 1));
        if (!b.isFunction(a)) throw new TypeError();
        d = i.call(arguments, 2);
        return (e = function () {
          if (!(this instanceof e))
            return a.apply(c, d.concat(i.call(arguments)));
          x.prototype = a.prototype;
          var b = new x();
          x.prototype = null;
          var g = a.apply(b, d.concat(i.call(arguments)));
      ...
      b.throttle = function (a, b, d) {
        ...
        d || (d = {});
        var j = function () {
          i = d.leading === false ? 0 : new Date();
          h = null;
          g = a.apply(e, f);
        };
        return function () {
          var k = new Date();
          !i && d.leading === false && (i = k);
          var K = b - (k - i);
          e = this;
          f = arguments;
          if (K <= 0) {
            ...
            i = k;
            g = a.apply(e, f);
          } else !h && d.trailing !== false && (h = setTimeout(j, K));
          return g;
        };
      };
      ...
      b.keys =
        ...
        function (a) {
          ...
          var c = [],
            d;
          for (d in a) b.has(a, d) && c.push(d);
          return c;
        };
      b.values = function (a) {
        for (var c = b.keys(a), d = c.length, e = Array(d), f = 0; f < d; f++)
          e[f] = a[c[f]];
        return e;
      };
      b.pairs = function (a) {
      ...
      b.invert = function (a) {
        for (var c = {}, d = b.keys(a), e = 0, f = d.length; e < f; e++)
          c[a[d[e]]] = d[e];
        return c;
      };
      ...
      b.pick = function (a) {
        var b = {},
          d = r.apply(k, i.call(arguments, 1));
        j(d, function (d) {
          d in a && (b[d] = a[d]);
        });
        return b;
      ...
      b.defaults = function (a) {
        j(i.call(arguments, 1), function (b) {
          if (b) for (var d in b) a[d] === void 0 && (a[d] = b[d]);
        });
        return a;
      };
      b.clone = function (a) {
      ...
      var y = function (a, c, d, e) {
        ...
        for (var g = d.length; g--; ) if (d[g] == a) return e[g] == c;
        var g = a.constructor,
          h = c.constructor;
        if (
          g !== h &&
          (!b.isFunction(g) ||
            !(g instanceof g && b.isFunction(h) && h instanceof h))
        )
          return false;
        d.push(a);
        e.push(c);
        ...
        if (f == "[object Array]") {
          g = a.length;
          if ((h = g == c.length))
            for (; g--; ) if (!(h = y(a[g], c[g], d, e))) break;
        } else {
          for (var i in a)
            if (b.has(a, i)) {
              g++;
              if (!(h = b.has(c, i) && y(a[i], c[i], d, e))) break;
            }
          if (h) {
            for (i in c) if (b.has(c, i) && !g--) break;
            h = !g;
          }
        }
        d.pop();
      ...
      b.isBoolean = function (a) {
        return a === true || a === false || m.call(a) == "[object Boolean]";
      };
      b.isNull = function (a) {
        return a === null;
      };
      ...
      b.times = function (a, b, d) {
        for (var e = Array(Math.max(0, a)), f = 0; f < a; f++)
          e[f] = b.call(d, f);
        return e;
      };
      ...
      var O = {
        escape: RegExp("[" + b.keys(n.escape).join("") + "]", "g"),
        unescape: RegExp("(" + b.keys(n.unescape).join("|") + ")", "g"),
      };
      b.each(["escape", "unescape"], function (a) {
        b[a] = function (b) {
          return b == null
            ? ""
            : ("" + b).replace(O[a], function (b) {
                return n[a][b];
              });
        };
      });
      ...
      b.template = function (a, c, d) {
        ...
        a.replace(f, function (b, c, d, e, f) {
          h =
            h +
            a.slice(g, f).replace(R, function (a) {
              return "\\" + Q[a];
            });
