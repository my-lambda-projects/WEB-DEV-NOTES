    ...
    (function (d) {
      function l(a) {
        ...
        return a && a.constructor == Array && 3 == a.length
          ...
          ? [parseInt(b[1], 10), parseInt(b[2], 10), parseInt(b[3], 10)]
          ...
          : (b = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(a))
        ...
        for (b in a)
          (c = a[b]),
            (null == c ||
              ...
              b in q ||
              /scrollbar/.test(b) ||
              (!/color/i.test(b) && isNaN(parseFloat(c)))) &&
              delete a[b];
        return a;
      }
      function r(a, b) {
      ...
      function i(a, b, c, e) {
        "object" == typeof a && ((e = b), (c = null), (b = a), (a = b.effect));
        d.isFunction(b) && ((e = b), (c = null), (b = {}));
        if ("number" == typeof b || d.fx.speeds[b]) (e = c), (c = b), (b = {});
        d.isFunction(c) && ((e = c), (c = null));
        b = b || {};
        c = c || b.duration;
        c = d.fx.off
          ? 0
      ...
      function j(a) {
        return !a ||
          "number" === typeof a ||
          d.fx.speeds[a] ||
          ("string" === typeof a && !d.effects[a])
          ? !0
          : !1;
      }
      d.effects = {};
      d.each(
        "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor borderColor color outlineColor".split(
          " "
        ),
        function (a, b) {
          d.fx.step[b] = function (a) {
            if (!a.colorInit) {
              ...
              var f = b,
                g;
              do {
                g = (d.curCSS || d.css)(e, f);
                if ((g != "" && g != "transparent") || d.nodeName(e, "body"))
                  break;
                f = "backgroundColor";
      ...
      d.effects.animateClass = function (a, b, c, e) {
        d.isFunction(c) && ((e = c), (c = null));
        return this.queue(function () {
          var f = d(this),
            ...
            i,
            j = f.attr("class") || "";
          d.each(p, function (b, c) {
            if (a[c]) f[c + "Class"](a[c]);
          });
          i = o(n.call(this));
          f.attr("class", j);
          f.animate(r(h, i), {
      ...
      d.fn.extend({
        ...
        removeClass: function (a, b, c, e) {
          return b
            ? d.effects.animateClass.apply(this, [{ remove: a }, b, c, e])
            : this._removeClass(a);
        },
        _toggleClass: d.fn.toggleClass,
        toggleClass: function (a, b, c, e, f) {
          return "boolean" == typeof b || void 0 === b
            ? c
              ...
              : this._toggleClass(a, b)
            : d.effects.animateClass.apply(this, [{ toggle: a }, b, c, e]);
        },
        switchClass: function (a, b, c, e, f) {
      ...
      d.extend(d.effects, {
        ...
        createWrapper: function (a) {
          ...
          a.wrap(c);
          (a[0] === e || d.contains(a[0], e)) && d(e).focus();
          c = a.parent();
          "static" == a.css("position")
            ? (c.css({ position: "relative" }), a.css({ position: "relative" }))
            : (d.extend(b, {
        ...
        removeWrapper: function (a) {
          ...
          return a.parent().is(".ui-effects-wrapper")
            ? ((b = a.parent().replaceWith(a)),
              (a[0] === c || d.contains(a[0], c)) && d(c).focus(),
              b)
            : a;
        },
      ...
      d.fn.extend({
        ...
        _show: d.fn.show,
        show: function (a) {
          if (j(a)) return this._show.apply(this, arguments);
        ...
        _hide: d.fn.hide,
        hide: function (a) {
          if (j(a)) return this._hide.apply(this, arguments);
          var b = i.apply(this, arguments);
          b[1].mode = "hide";
          return this.effect.apply(this, b);
        },
        ...
        toggle: function (a) {
          if (j(a) || "boolean" === typeof a || d.isFunction(a))
      ...
      var k = {};
      d.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function (a, b) {
        k[b] = function (b) {
      ...
      d.each(k, function (a, b) {
        ...
        d.easing["easeInOut" + a] = function (a) {
          return 0.5 > a ? b(2 * a) / 2 : b(-2 * a + 2) / -2 + 1;
        };
      });
    })(jQuery);
} catch (e) {
    ...
    b.effects.blind = function (c) {
      return this.queue(function () {
        ...
        var e = b.effects.createWrapper(a).css({ overflow: "hidden" }),
          h = "vertical" == d ? "height" : "width",
          d = "vertical" == d ? e.height() : e.width();
        "show" == f && e.css(h, 0);
        var i = {};
        i[h] = "show" == f ? d : 0;
  ...
  (function (e) {
    e.effects.bounce = function (b) {
      return this.queue(function () {
        ...
        var f = "up" == d || "down" == d ? "top" : "left",
          d = "up" == d || "left" == d ? "pos" : "neg",
          c =
            b.options.distance ||
            ("top" == f ? a.outerHeight(!0) / 3 : a.outerWidth(!0) / 3);
        "show" == h && a.css("opacity", 0).css(f, "pos" == d ? -c : c);
        "hide" == h && (c /= 2 * m);
        "hide" != h && m--;
        if ("show" == h) {
          var g = { opacity: 1 };
        ...
        "hide" == h
          ...
          : ((j = {}),
            ...
            (k[f] = ("pos" == d ? "+=" : "-=") + c),
            a
              .animate(j, i / 2, b.options.easing)
              .animate(k, i / 2, b.options.easing, function () {
                e.effects.restore(a, l);
                e.effects.removeWrapper(a);
                b.callback && b.callback.apply(this, arguments);
              }));
    ...
    b.effects.clip = function (e) {
      return this.queue(function () {
        ...
        var d = b.effects.createWrapper(a).css({ overflow: "hidden" }),
          d = "IMG" == a[0].tagName ? d : a,
          i = "vertical" == c ? "height" : "width",
          j = "vertical" == c ? "top" : "left",
          c = "vertical" == c ? d.height() : d.width();
        "show" == f && (d.css(i, 0), d.css(j, c / 2));
        var g = {};
        g[i] = "show" == f ? c : 0;
        g[j] = "show" == f ? 0 : c / 2;
        d.animate(g, {
...
try {
  ...
  (function (c) {
    c.effects.drop = function (d) {
      return this.queue(function () {
        var a = c(this),
          h = "position top bottom left right opacity".split(" "),
          e = c.effects.setMode(a, d.options.mode || "hide"),
          b = d.options.direction || "left";
        c.effects.save(a, h);
        a.show();
        c.effects.createWrapper(a);
        var f = "up" == b || "down" == b ? "top" : "left",
          b = "up" == b || "left" == b ? "pos" : "neg",
          g =
            d.options.distance ||
            ("top" == f ? a.outerHeight(!0) / 2 : a.outerWidth(!0) / 2);
        "show" == e && a.css("opacity", 0).css(f, "pos" == b ? -g : g);
        var i = { opacity: "show" == e ? 1 : 0 };
        i[f] =
          ("show" == e
            ? "pos" == b
              ? "+="
    ...
    j.effects.explode = function (a) {
      return this.queue(function () {
        ...
        var b = j(this).show().css("visibility", "hidden"),
          e = b.offset();
        e.top -= parseInt(b.css("marginTop"), 10) || 0;
        e.left -= parseInt(b.css("marginLeft"), 10) || 0;
        for (var h = b.outerWidth(!0), i = b.outerHeight(!0), f = 0; f < c; f++)
          for (var g = 0; g < d; g++)
            b.clone()
              .appendTo("body")
              .wrap("<div></div>")
              ...
              .css({
                ...
                left:
                  ...
                  g * (h / d) +
                  ("show" == a.options.mode
                    ? (g - Math.floor(d / 2)) * (h / d)
                    : 0),
                top:
                  e.top +
                  f * (i / c) +
                  ("show" == a.options.mode
                    ? (f - Math.floor(c / 2)) * (i / c)
                    : 0),
                opacity: "show" == a.options.mode ? 0 : 1,
              })
              .animate(
                {
                  left:
                  ...
                  top:
                    ...
                    ("show" == a.options.mode
                      ? 0
                      : (f - Math.floor(c / 2)) * (i / c)),
                  opacity: "show" == a.options.mode ? 1 : 0,
                },
                a.duration || 500
              );
        setTimeout(function () {
    ...
    c.effects.fold = function (a) {
      return this.queue(function () {
        ...
        var e = c.effects.createWrapper(b).css({ overflow: "hidden" }),
          ...
          i = /([0-9]+)%/.exec(g);
        i && (g = (parseInt(i[1], 10) / 100) * f["hide" == d ? 0 : 1]);
        "show" == d &&
...
try {
  ...
  (function (e) {
    e.effects.pulsate = function (a) {
      return this.queue(function () {
        var b = e(this),
          d = e.effects.setMode(b, a.options.mode || "show"),
          g = 2 * (a.options.times || 5) - 1,
          h = a.duration ? a.duration / 2 : e.fx.speeds._default / 2,
          f = b.is(":visible"),
          c = 0;
        f || (b.css("opacity", 0).show(), (c = 1));
        (("hide" == d && f) || ("show" == d && !f)) && g--;
        for (d = 0; d < g; d++)
          b.animate({ opacity: c }, h, a.options.easing), (c = (c + 1) % 2);
        b.animate({ opacity: c }, h, a.options.easing, function () {
          c == 0 && b.hide();
          a.callback && a.callback.apply(this, arguments);
        });
        b.queue("fx", function () {
...
try {
  ...
  (function (c) {
    c.effects.puff = function (b) {
      return this.queue(function () {
        var a = c(this),
          d = c.effects.setMode(a, b.options.mode || "hide"),
          e = parseInt(b.options.percent, 10) || 150,
          i = e / 100,
          g = { height: a.height(), width: a.width() };
        c.extend(b.options, {
          fade: !0,
          mode: d,
          percent: "hide" == d ? e : 100,
          from: "hide" == d ? g : { height: g.height * i, width: g.width * i },
        });
    ...
    c.effects.scale = function (b) {
      return this.queue(function () {
        var a = c(this),
          d = c.extend(!0, {}, b.options),
          e = c.effects.setMode(a, b.options.mode || "effect"),
          i =
            parseInt(b.options.percent, 10) ||
            (0 == parseInt(b.options.percent, 10) ? 0 : "hide" == e ? 0 : 100),
          g = b.options.direction || "both",
          f = b.options.origin;
        "effect" != e &&
          ((d.origin = f || ["middle", "center"]), (d.restore = !0));
        f = { height: a.height(), width: a.width() };
        a.from = b.options.from || ("show" == e ? { height: 0, width: 0 } : f);
        a.to = {
          height: f.height * ("horizontal" != g ? i / 100 : 1),
          width: f.width * ("vertical" != g ? i / 100 : 1),
        };
        if (
          b.options.fade &&
          ("show" == e && ((a.from.opacity = 0), (a.to.opacity = 1)),
          "hide" == e)
        )
        ...
        d.to = a.to;
        d.mode = e;
        a.effect("size", d, b.duration, b.callback);
        a.dequeue();
      });
    };
    c.effects.size = function (b) {
      return this.queue(function () {
        var a = c(this),
          d = "position top bottom left right width height overflow opacity".split(
            " "
          ),
          ...
          r = c.effects.setMode(a, b.options.mode || "effect"),
          q = b.options.restore || !1,
          n = b.options.scale || "both",
          k = b.options.origin,
          h = { height: a.height(), width: a.width() };
        a.from = b.options.from || h;
        a.to = b.options.to || h;
        k &&
          ((k = c.effects.getBaseline(k, h)),
          (a.from.top = (h.height - a.from.height) * k.y),
          (a.from.left = (h.width - a.from.width) * k.x),
          (a.to.top = (h.height - a.to.height) * k.y),
          (a.to.left = (h.width - a.to.width) * k.x));
        var l = a.from.height / h.height,
          o = a.from.width / h.width,
          m = a.to.height / h.height,
          p = a.to.width / h.width;
        if ("box" == n || "both" == n)
          if (
            (l != m &&
              ((d = d.concat(f)),
              (a.from = c.effects.setTransition(a, f, l, a.from)),
              (a.to = c.effects.setTransition(a, f, m, a.to))),
            o != p)
          )
            (d = d.concat(j)),
              (a.from = c.effects.setTransition(a, j, o, a.from)),
              (a.to = c.effects.setTransition(a, j, p, a.to));
        if (("content" == n || "both" == n) && l != m)
          (d = d.concat(g)),
            (a.from = c.effects.setTransition(a, g, l, a.from)),
            (a.to = c.effects.setTransition(a, g, m, a.to));
        c.effects.save(a, q ? d : e);
        a.show();
        c.effects.createWrapper(a);
        ...
        if ("content" == n || "both" == n)
          (f = f.concat(["marginTop", "marginBottom"]).concat(g)),
            ...
            (i = d.concat(f).concat(j)),
            a.find("*[width]").each(function () {
              var a = c(this);
              q && c.effects.save(a, i);
              var d = a.height(),
                e = a.width();
              a.from = { height: d * l, width: e * o };
              a.to = { height: d * m, width: e * p };
              if (l != m) {
                a.from = c.effects.setTransition(a, f, l, a.from);
                a.to = c.effects.setTransition(a, f, m, a.to);
              }
              ...
              a.css(a.from);
              a.animate(a.to, b.duration, b.options.easing, function () {
                q && c.effects.restore(a, i);
              });
            });
        a.animate(a.to, {
          queue: !1,
  ...
  (function (c) {
    c.effects.slide = function (d) {
      return this.queue(function () {
        ...
        var g = "up" == b || "down" == b ? "top" : "left",
          b = "up" == b || "left" == b ? "pos" : "neg",
          e =
            d.options.distance ||
            ("top" == g ? a.outerHeight(!0) : a.outerWidth(!0));
        "show" == f && a.css(g, "pos" == b ? (isNaN(e) ? "-" + e : -e) : e);
        var i = {};
        i[g] =
          ("show" == f
            ? "pos" == b
