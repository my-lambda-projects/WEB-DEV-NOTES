/*! License: Tc3txfyTCX.LICENSE.txt */
    ...
    "35H0": function ( e, t, n ) {
      ...
      ( function ( e ) {
        ...
        function m( e, t ) {
          ...
          var p = h( e );
          return p.host ? m( p.host, t ) : m( e, h( t ).host )
        }
        ...
        function D( e ) {
          ...
          if ( p || l ) {
            var u = a( e );
            p -= b( u, "x" ), l -= b( u, "y" ), o.width -= p, o.height -= l
          }
          return T( o )
        }
        ...
        function M( e, t ) {
          ...
          return ( r && !n ? t.contains( p ) : t === p && "BODY" !== p.nodeName ) && ( h = g( h, t ) ), h
        }
        ...
        function H( e, t, n, r ) {
          ...
          if ( "viewport" === r ) i = N( a, o );
            ...
            var l = void 0;
            "scrollParent" === r ? "BODY" === ( l = s( f( t ) ) ).nodeName && ( l = e.ownerDocument.documentElement ) : l = "window" === r ? e.ownerDocument.documentElement : r;
            var u = M( l, a, o );
            if ( "HTML" !== l.nodeName || F( a ) ) i = u;
            else {
        ...
        function W( e, t, n ) {
          ...
          var r = S( e ),
            ...
            s = i ? "height" : "width",
            p = i ? "width" : "height";
          return o[ a ] = t[ a ] + t[ s ] / 2 - r[ s ] / 2, o[ f ] = n === f ? t[ f ] - r[ p ] : t[ P( f ) ], o
        }
        ...
        function R() {
          if ( !this.state.isDestroyed ) {
            ...
            e.offsets.reference = C( this.state, this.popper, this.reference, this.options.positionFixed ), e.placement = A( this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding ), e.originalPlacement = e.placement, e.positionFixed = this.options.positionFixed, e.offsets.popper = W( this.popper, e.offsets.reference, e.placement ), e.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", e = I( this.modifiers, e ), this.state.isCreated ? this.options.onUpdate( e ) : ( this.state.isCreated = !0, this.options.onCreate( e ) )
          }
        }
            ...
            modifiers: {
              ...
              offset: {
                ...
                fn: function ( e, t ) {
                  var n = t.offset,
                    ...
                    f = r.split( "-" )[ 0 ],
                    s = void 0;
                  return s = _( +n ) ? [ +n, 0 ] : oe( n, i, a, f ), "left" === f ? ( i.top += s[ 0 ], i.left -= s[ 1 ] ) : "right" === f ? ( i.top += s[ 0 ], i.left += s[ 1 ] ) : "top" === f ? ( i.left += s[ 0 ], i.top -= s[ 1 ] ) : "bottom" === f && ( i.left += s[ 0 ], i.top += s[ 1 ] ), e.popper = i, e
                },
                offset: 0
              },
              preventOverflow: {
                ...
                fn: function ( e, t ) {
                  ...
                  var r = V( "transform" ),
                    ...
                    f = o[ r ];
                  o.top = "", o.left = "", o[ r ] = "";
                  var s = H( e.instance.popper, e.instance.reference, t.padding, n, e.positionFixed );
                    ...
                    u = {
                      ...
                      secondary: function ( e ) {
                        var n = "right" === e ? "left" : "top",
                          r = l[ n ];
                        return l[ e ] > s[ e ] && !t.escapeWithReference && ( r = Math.min( l[ n ], s[ e ] - ( "right" === e ? l.width : l.height ) ) ), O( {}, n, r )
                      }
                    };
              ...
              arrow: {
                ...
                fn: function ( e, t ) {
                  ...
                  var o = e.placement.split( "-" )[ 0 ],
                    ...
                    h = p ? "bottom" : "right",
                    m = S( r )[ l ];
                  s[ h ] - m < f[ c ] && ( e.offsets.popper[ c ] -= f[ c ] - ( s[ h ] - m ) ), s[ c ] + m > f[ h ] && ( e.offsets.popper[ c ] += s[ c ] + m - f[ h ] ), e.offsets.popper = T( e.offsets.popper );
                  var v = s[ c ] + s[ l ] / 2 - m / 2,
                    g = a( e.instance.popper ),
                    b = parseFloat( g[ "margin" + u ] ),
                    w = parseFloat( g[ "border" + u + "Width" ] ),
                    y = v - e.offsets.popper[ c ] - b - w;
                  return y = Math.max( Math.min( f[ l ] - m, y ), 0 ), e.arrowElement = r, e.offsets.arrow = ( O( n = {}, c, Math.round( y ) ), O( n, d, "" ), n ), e
                },
                element: "[x-arrow]"
              },
              flip: {
                ...
                fn: function ( e, t ) {
                  ...
                  return a.forEach( ( function ( f, s ) {
                    ...
                    var p = e.offsets.popper,
                      ...
                      x = w || y;
                    ( c || g || x ) && ( e.flipped = !0, ( c || g ) && ( r = a[ s + 1 ] ), x && ( i = function ( e ) {
                      return "end" === e ? "start" : "start" === e ? "end" : e
                    }( i ) ), e.placement = r + ( i ? "-" + i : "" ), e.offsets.popper = L( {}, e.offsets.popper, W( e.instance.popper, e.offsets.reference, e.placement ) ), e = I( e.instance.modifiers, e, "flip" ) )
                  } ) ), e
                },
                behavior: "flip",
                padding: 5,
              ...
              inner: {
                ...
                fn: function ( e ) {
                  ...
                  return o[ a ? "left" : "top" ] = i[ n ] - ( f ? o[ a ? "width" : "height" ] : 0 ), e.placement = P( t ), e.offsets.popper = T( o ), e
                }
              },
              hide: {
                order: 800,
                  ...
                  var a = void 0 !== i ? i : t.gpuAcceleration,
                    ...
                    l = function ( e, t ) {
                      var n = e.offsets,
                        ...
                        c = t ? l || u || s % 2 == p % 2 ? i : a : f,
                        d = t ? i : f;
                      return {
                        left: c( s % 2 == 1 && p % 2 == 1 && !u && t ? r.left - 1 : r.left ),
                        top: d( r.top ),
                        bottom: d( r.bottom ),
                        right: c( r.right )
                      }
                    ...
                    m = void 0,
                    v = void 0;
                  if ( v = "bottom" === u ? "HTML" === f.nodeName ? -f.clientHeight + l.bottom : -s.height + l.bottom : l.top, m = "right" === c ? "HTML" === f.nodeName ? -f.clientWidth + l.right : -s.width + l.right : l.left, a && h ) p[ h ] = "translate3d(" + m + "px, " + v + "px, 0)", p[ u ] = 0, p[ c ] = 0, p.willChange = "transform";
                  else {
                    var g = "bottom" === u ? -1 : 1,
                      b = "right" === c ? -1 : 1;
                    p[ u ] = v * g, p[ c ] = m * b, p.willChange = u + ", " + c
                  }
                  var w = {
                    "x-placement": e.placement
                  };
                  return e.attributes = L( {}, w, e.attributes ), e.styles = L( {}, p, e.styles ), e.arrowStyles = L( {}, e.offsets.arrow, e.arrowStyles ), e
                },
                gpuAcceleration: !0,
                x: "bottom",
                y: "right"
...
//# sourceMappingURL=4.2mQ3CGM1MD.js.map
