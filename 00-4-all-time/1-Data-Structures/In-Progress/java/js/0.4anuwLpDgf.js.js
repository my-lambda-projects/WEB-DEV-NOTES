  ...
  [ 0 ], {
    ...
    bLpi: function ( e, t, n ) {
      ...
      function c( {
        ...
        const [ l, d ] = t, m = Object( r.useMemo )( () => [ ...a, {
          name: "offset",
          options: {
            offset: [ l, d ]
          }
        } ], [ l, d ] ), h = Object( r.useMemo )( () => null == u ? m : [ ...m, ...u ], [ m, u ] );
          ...
          return function e( t, a ) {
            ...
            if ( t && a && "object" == typeof t && "object" == typeof a ) {
              ...
              if ( Array.isArray( t ) ) {
                ...
                for ( f = s; 0 != f--; )
                  if ( !e( t[ f ], a[ f ] ) ) return !1;
                return !0
              }
              if ( r && t instanceof Map && a instanceof Map ) {
                if ( t.size !== a.size ) return !1;
                for ( u = t.entries(); !( f = u.next() ).done; )
              ...
              for ( f = s; 0 != f--; )
                if ( ( "_owner" !== c[ f ] && "__v" !== c[ f ] && "__o" !== c[ f ] || !t.$$typeof ) && !e( t[ c[ f ] ], a[ c[ f ] ] ) ) return !1;
              return !0
            }
            return t != t && a != a
          }( e, t )
    ...
    ewQW: function ( e, t, n ) {
      ...
      function d( e ) {
        return a( l( e ) ).left + f( e ).scrollLeft
      }
      ...
      function v( e, t, n ) {
        ...
        return ( m || !m && !n ) && ( ( "body" !== p( t ) || h( i ) ) && ( v = ( r = t ) !== s( r ) && u( r ) ? {
          scrollLeft: ( o = r ).scrollLeft,
          scrollTop: o.scrollTop
        } : f( r ) ), u( t ) ? ( ( y = a( t ) ).x += t.clientLeft, y.y += t.clientTop ) : i && ( y.x = d( i ) ) ), {
          x: c.left + v.scrollLeft - y.x,
          y: c.top + v.scrollTop - y.y,
          width: c.width,
          height: c.height
        }
      }
      ...
      function g( e ) {
        return "html" === p( e ) ? e : e.assignedSlot || e.parentNode || e.host || l( e )
      }

      function b( e, t ) {
        void 0 === t && ( t = [] );
        var n = function e( t ) {
            return [ "html", "body", "#document" ].indexOf( p( t ) ) >= 0 ? t.ownerDocument.body : u( t ) && h( t ) ? t : e( g( t ) )
          }( e ),
          r = "body" === p( n ),
          o = s( n ),
          i = r ? [ o ].concat( o.visualViewport || [], h( n ) ? n : [] ) : n,
          a = t.concat( i );
        return r ? a : a.concat( b( g( i ) ) )
      }
      ...
      function w( e ) {
        if ( !u( e ) || "fixed" === m( e ).position ) return null;
        var t = e.offsetParent;
        if ( t ) {
          var n = l( t );
          if ( "body" === p( t ) && "static" === m( t ).position && "static" !== m( n ).position ) return n
        }
        return t
      }

      function x( e ) {
        for ( var t = s( e ), n = w( e ); n && O( n ) && "static" === m( n ).position; ) n = w( n );
        return n && "body" === p( n ) && "static" === m( n ).position ? t : n || function ( e ) {
          for ( var t = g( e ); u( t ) && [ "html", "body" ].indexOf( p( t ) ) < 0; ) {
            var n = m( t );
      ...
      var j = "top",
        ...
        A = [].concat( P, [ "auto" ] ).reduce( ( function ( e, t ) {
            ...
            p = {
              ...
              setOptions: function ( n ) {
                l(), s.options = Object.assign( Object.assign( Object.assign( {}, i ), s.options ), n ), s.scrollParents = {
                  reference: c( e ) ? b( e ) : e.contextElement ? b( e.contextElement ) : [],
                  popper: b( t )
                };
                var o = function ( e ) {
                  var t = S( e );
              ...
              forceUpdate: function () {
                if ( !u ) {
                  ...
                  if ( R( t, n ) ) {
                    s.rects = {
                      reference: v( t, x( n ), "fixed" === s.options.strategy ),
                      popper: y( n )
      ...
      function F( e ) {
        ...
        if ( c ) {
          var b = x( n );
          b === s( n ) && ( b = l( n ) ), o === j && ( y = E, d -= b.clientHeight - r.height, d *= f ? 1 : -1 ), o === D && ( v = M, p -= b.clientWidth - r.width, p *= f ? 1 : -1 )
        }
        var O, w = Object.assign( {
          position: a
        }, c && V );
        return f ? Object.assign( Object.assign( {}, w ), {}, ( ( O = {} )[ y ] = h ? "0" : "", O[ v ] = m ? "0" : "", O.transform = ( g.devicePixelRatio || 1 ) < 2 ? "translate(" + p + "px, " + d + "px)" : "translate3d(" + p + "px, " + d + "px, 0)", O ) ) : Object.assign( Object.assign( {}, w ), {}, ( ( t = {} )[ y ] = h ? d + "px" : "", t[ v ] = m ? p + "px" : "", t.transform = "", t ) )
      }
      var N = {
        left: "right",
        right: "left",
      ...
      function X( e, t ) {
        return "viewport" === t ? J( function ( e ) {
          var t = s( e ),
            n = l( e ),
            r = t.visualViewport,
            o = n.clientWidth,
            ...
            a = 0,
            f = 0;
          return r && ( o = r.width, i = r.height, /^((?!chrome|android).)*safari/i.test( navigator.userAgent ) || ( a = r.offsetLeft, f = r.offsetTop ) ), {
            width: o,
            height: i,
            x: a + d( e ),
            y: f
      ...
      function Y( e, t, n ) {
        var r = "clippingParents" === t ? function ( e ) {
            var t = b( g( e ) ),
              n = [ "absolute", "fixed" ].indexOf( m( e ).position ) >= 0 && u( e ) ? x( e ) : e;
      ...
      function K( e, t ) {
        ...
        var n = t,
          ...
          v = n.padding,
          y = void 0 === v ? 0 : v,
          g = $( "number" != typeof y ? y : G( y, P ) ),
          b = "popper" === d ? "reference" : "popper",
          O = e.elements.reference,
          w = e.rects.popper,
          x = e.elements[ h ? b : d ],
          D = Y( c( x ) ? x : x.contextElement || l( e.elements.popper ), s, u ),
          k = a( O ),
          A = q( {
            reference: k,
            element: w,
          ...
          B = J( Object.assign( Object.assign( {}, w ), A ) ),
          S = "popper" === d ? B : k,
          L = {
            top: D.top - S.top + g.top,
            bottom: S.bottom - D.bottom + g.bottom,
            left: D.left - S.left + g.left,
            right: S.right - D.right + g.right
          },
      ...
      function te( e ) {
        return [ j, M, E, D ].some( ( function ( t ) {
          return e[ t ] >= 0
        } ) )
      }
      var ne = W( {
          defaultModifiers: [ {
            ...
            fn: function ( e ) {
              ...
              null != t.modifiersData.popperOffsets && ( t.styles.popper = Object.assign( Object.assign( {}, t.styles.popper ), F( Object.assign( Object.assign( {}, s ), {}, {
                offsets: t.modifiersData.popperOffsets,
                position: t.options.strategy,
                adaptive: a
              } ) ) ) ), null != t.modifiersData.arrow && ( t.styles.arrow = Object.assign( Object.assign( {}, t.styles.arrow ), F( Object.assign( Object.assign( {}, s ), {}, {
            ...
            fn: function ( e ) {
              ...
              Object.keys( t.elements ).forEach( ( function ( e ) {
                var n = t.styles[ e ] || {},
                  r = t.attributes[ e ] || {},
                  o = t.elements[ e ];
                u( o ) && p( o ) && ( Object.assign( o.style, n ), Object.keys( r ).forEach( ( function ( e ) {
                  var t = r[ e ];
              ...
              return Object.assign( t.elements.popper.style, n.popper ), t.elements.arrow && Object.assign( t.elements.arrow.style, n.arrow ),
                function () {
                  Object.keys( t.elements ).forEach( ( function ( e ) {
                    ...
                    u( r ) && p( r ) && ( Object.assign( r.style, i ), Object.keys( o ).forEach( ( function ( e ) {
                      r.removeAttribute( e )
                    } ) ) )
                  } ) )
                }
                ...
                a = A.reduce( ( function ( e, n ) {
                  return e[ n ] = function ( e, t, n ) {
                    var r = U( e ),
                      ...
                      a = i[ 0 ],
                      s = i[ 1 ];
                    return a = a || 0, s = ( s || 0 ) * o, [ D, M ].indexOf( r ) >= 0 ? {
                      x: s,
                      y: a
                    } : {
                      x: a,
            ...
            fn: function ( e ) {
              ...
              if ( !t.modifiersData[ r ]._skip ) {
                for ( var o = n.mainAxis, i = void 0 === o || o, a = n.altAxis, s = void 0 === a || a, f = n.fallbackPlacements, c = n.padding, u = n.boundary, p = n.rootBoundary, l = n.altBoundary, d = n.flipVariations, m = void 0 === d || d, h = n.allowedAutoPlacements, v = t.options.placement, y = U( v ), g = f || ( y === v || !m ? [ _( v ) ] : function ( e ) {
                    if ( "auto" === U( e ) ) return [];
                    var t = _( e );
                    return [ I( e ), t, I( t ) ]
                  ...
                  } ), [] ), O = t.rects.reference, w = t.rects.popper, x = new Map, B = !0, S = b[ 0 ], L = 0; L < b.length; L++ ) {
                  var R = b[ L ],
                    W = U( R ),
                    H = "start" === T( R ),
                    C = [ j, E ].indexOf( W ) >= 0,
                  ...
                  var N = _( F ),
                    z = [];
                  if ( i && z.push( V[ W ] <= 0 ), s && z.push( V[ F ] <= 0, V[ N ] <= 0 ), z.every( ( function ( e ) {
                      return e
                    } ) ) ) {
                    S = R, B = !1;
                    break
              ...
              if ( k ) {
                if ( i ) {
                  var R = "y" === w ? j : D,
                    ...
                    Y = J[ W ],
                    $ = Z( 0, A[ H ], Q[ H ] ),
                    G = O ? A[ H ] / 2 - N - $ - X - S : _ - $ - X - S,
                    ee = O ? -A[ H ] / 2 + N + $ + Y + S : z + $ + Y + S,
                    te = t.elements.arrow && x( t.elements.arrow ),
                    ne = te ? "y" === w ? te.clientTop || 0 : te.clientLeft || 0 : 0,
                    re = t.modifiersData.offset ? t.modifiersData.offset[ t.placement ][ w ] : 0,
                    oe = k[ w ] + G - re - ne,
                    ie = k[ w ] + ee - re,
                    ae = Z( d ? Math.min( V, oe ) : V, q, d ? Math.max( F, ie ) : F );
                  k[ w ] = ae, L[ w ] = ae - q
                }
                if ( s ) {
                  var se = "x" === w ? j : D,
            ...
            fn: function ( e ) {
              var t, n = e.state,
                ...
                a = U( n.placement ),
                s = C( a ),
                f = [ D, M ].indexOf( a ) >= 0 ? "height" : "width";
              if ( o && i ) {
                var c = n.modifiersData[ r + "#persistent" ].padding,
                  u = y( o ),
                  p = "y" === s ? j : D,
                  l = "y" === s ? E : M,
                  d = n.rects.reference[ f ] + n.rects.reference[ s ] - i[ s ] - n.rects.popper[ f ],
                  ...
                  P = Z( b, w, O ),
                  k = s;
                n.modifiersData[ r ] = ( ( t = {} )[ k ] = P, t.centerOffset = P - w, t )
              }
            },
            effect: function ( e ) {
              var t = e.state,
              ...
              null != i && ( "string" != typeof i || ( i = t.elements.popper.querySelector( i ) ) ) && Q( t.elements.popper, i ) && ( t.elements.arrow = i, t.modifiersData[ r + "#persistent" ] = {
                padding: $( "number" != typeof s ? s : G( s, P ) )
              } )
            },
            requires: [ "popperOffsets" ],
        ...
        var w = r.useMemo( ( function () {
              ...
              u = r.useMemo( ( function () {
                return {
                  ...
                  fn: function ( e ) {
                    ...
                    c( {
                      styles: Object( i.a )( n.map( ( function ( e ) {
                        return [ e, t.styles[ e ] || {} ]
                      } ) ) ),
                      attributes: Object( i.a )( n.map( ( function ( e ) {
          ...
          P = r.useMemo( ( function () {
            return {
              ...
              hasPopperEscaped: j && j.modifiersData.hide ? j.modifiersData.hide.hasPopperEscaped : null,
              isReferenceHidden: j && j.modifiersData.hide ? j.modifiersData.hide.isReferenceHidden : null,
              arrowProps: {
                style: E.arrow,
                ref: O
              },
