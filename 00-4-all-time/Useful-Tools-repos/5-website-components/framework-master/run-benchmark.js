...
const { runBench } = require('./dist/dev/tests/core/benchmark/runner/src/benchmarkRunner.js.js');
const {
	processBenchmarkResults
} = require('./dist/dev/tests/core/benchmark/runner/process-benchmark-results.js.js');
