window.addEventListener("DOMContentLoaded", event => {
  ...
  const checkPasswordMatch = event => {
    ...
    const passwordValue = document.getElementById("password").value; //.value grabs the value the user inputs
  ...
  form.addEventListener("submit", checkPasswordMatch); //invokes check password match upon submit event
});