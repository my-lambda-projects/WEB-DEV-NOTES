window.addEventListener('DOMContentLoaded', (event) => {
	...
	// // Consolidated switch case from above
	// form.addEventListener('input', (e) => {
	// 	switch (e.target.id) {
	// 		case 'title':
	// 		case 'first-name':
	...
	// // Using the `focusin` event will bubble, so the useCapture argument is not needed for addEventListener
	// form.addEventListener(
	// 	'focusin',
	// 	(e) => {
	// 		console.log(`Target:`);
	...
	// // Adding the event to the input directly will not require bubbling either
	// // This would require us to add the event listener to each individual input, though, which is probably not the best approach.
